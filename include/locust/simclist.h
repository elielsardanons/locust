...
/*!
 * \file
 * \brief SimCList library. See http://mij.oltrelinux.com/devel/simclist
...
/*!
 * \brief Type representing list hashes.
 *
...
/*!
 * \brief Information about a dump.
 */
typedef struct {
...
/*!
 * \brief a function computing the hash of elements.
 *
...
/*!
 * \brief a function for serializing an element.
 *
...
/*!
 * \brief a function for un-serializing an element.
 *
...
/*!
 * \internal
 * \brief [private-use] list entry -- olds actual user datum
 */
struct list_entry_s {
    void *data;
...
/*!
 * \internal
 * \brief [private-use] list attributes
 */
...
/*!
 * \brief completely remove the list from memory.
 *
...
/*!
 * \brief set the comparator function for list elements.
 *
...
/*!
 * \brief set a seeker function for list elements.
 *
...
/*!
 * \brief require to free element data when list entry is removed (default: don't free).
 *
 * [ advanced preference ]
 *
...
/*!
 * \brief set the element hash computing function for the list elements.
 *
 * [ advanced preference ]
 *
...
/*!
 * \brief set the element serializer function for the list elements.
 *
 * [ advanced preference ]
 *
...
/*!
 * \brief set the element unserializer function for the list elements.
 *
 * [ advanced preference ]
 *
...
/*!
 * \brief append data at the end of the list.
 *
...
/*!
 * \brief insert data in the head of the list.
 *
...
/*!
 * \brief extract the element in the top of the list.
 *
...
/*!
 * \brief retrieve an element at a given position.
 *
 * \param l     list to operate
...
/*!
 * \brief return the maximum element of the list.
 *
...
/*!
 * \brief return the minimum element of the list.
 *
 * \warning Requires a comparator function to be set for the list.
 *
...
/*!
 * \brief retrieve and remove from list an element at a given position.
 *
 * \param l     list to operate
 * \param pos   [0,size-1] position index of the element wanted
 * \return      reference to user datum, or NULL on errors
...
/*!
 * \brief expunge an element at a given position from the list.
 *
 * \param l     list to operate
...
/*!
 * \brief expunge an array of elements from the list, given their position range.
 *
 * \param l     list to operate
...
/*!
 * \brief clear all the elements off of the list.
 *
...
/*!
 * \brief inspect the number of elements in the list.
 *
 * \param l     list to operate
...
/*!
 * \brief inspect whether the list is empty.
 *
 * \param l     list to operate
...
/*!
 * \brief find the position of an element in a list.
 *
 * \warning Requires a comparator function to be set for the list.
 *
...
/*!
 * \brief returns an element given an indicator.
 *
...
/*!
 * \brief inspect whether some data is member of the list.
 *
 * \warning Requires a comparator function to be set for the list.
 *
...
/*!
 * \brief start an iteration session.
 *
...
/*!
 * \brief return the next element in the iteration session.
 *
 * \param l     list to operate
...
/*!
 * \brief inspect whether more elements are available in the iteration session.
 *
 * \param l     list to operate
...
/*!
 * \brief end an iteration session.
 *
 * \param l     list to operate
...
/*!
 * \brief return the hash of the current status of the list.
 *
 * \param l     list to operate
...
/*!
 * \brief get meta informations on a list dump on filedescriptor.
 *
 * [ advanced function ]
 *
...
/*!
 * \brief get meta informations on a list dump on file.
 *
 * [ advanced function ]
 *
 * Extracts the meta information from a SimCList dump located in a file.
...
/*!
 * \brief dump the list into an open, writable file descriptor.
 *
...
/*!
 * \brief dump the list to a file name.
 *
...
/*!
 * \brief restore the list from an open, readable file descriptor to memory.
 *
...
/*!
 * \brief restore the list from a file name.
 *
...
int list_comparator_string(const void *a, const void *b);
                                ...
                                /*          metric functions        */
/*!
 * \brief ready-made metric function for int8_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_int8_t(const void *el);

/*!
 * \brief ready-made metric function for int16_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_int16_t(const void *el);

/*!
 * \brief ready-made metric function for int32_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_int32_t(const void *el);

/*!
 * \brief ready-made metric function for int64_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_int64_t(const void *el);

/*!
 * \brief ready-made metric function for uint8_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_uint8_t(const void *el);

/*!
 * \brief ready-made metric function for uint16_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_uint16_t(const void *el);

/*!
 * \brief ready-made metric function for uint32_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_uint32_t(const void *el);

/*!
 * \brief ready-made metric function for uint64_t elements.
 * \see list_attributes_copy()
 */
size_t list_meter_uint64_t(const void *el);

/*!
 * \brief ready-made metric function for float elements.
 * \see list_attributes_copy()
 */
size_t list_meter_float(const void *el);

/*!
 * \brief ready-made metric function for double elements.
 * \see list_attributes_copy()
 */
size_t list_meter_double(const void *el);

/*!
 * \brief ready-made metric function for string elements.
 * \see list_attributes_copy()
 */
size_t list_meter_string(const void *el);
                                ...
                                /*          hash functions          */
/*!
 * \brief ready-made hash function for int8_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_int8_t(const void *el);

/*!
 * \brief ready-made hash function for int16_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_int16_t(const void *el);

/*!
 * \brief ready-made hash function for int32_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_int32_t(const void *el);

/*!
 * \brief ready-made hash function for int64_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_int64_t(const void *el);

/*!
 * \brief ready-made hash function for uint8_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_uint8_t(const void *el);

/*!
 * \brief ready-made hash function for uint16_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_uint16_t(const void *el);

/*!
 * \brief ready-made hash function for uint32_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_uint32_t(const void *el);

/*!
 * \brief ready-made hash function for uint64_t elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_uint64_t(const void *el);

/*!
 * \brief ready-made hash function for float elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_float(const void *el);

/*!
 * \brief ready-made hash function for double elements.
 * \see list_attributes_hash_computer()
 */
list_hash_t list_hashcomputer_double(const void *el);

/*!
 * \brief ready-made hash function for string elements.
 * \see list_attributes_hash_computer()
 */
